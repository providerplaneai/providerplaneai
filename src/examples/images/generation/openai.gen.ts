import { saveFile, saveImageAsFile } from "#root/examples/shared.js";
import { AIClient, MultiModalExecutionContext } from "#root/index.js";

export const openai_image_gen = async () => {
...
export const openai_image_gen_stream = async () => {
    console.log("=== OpenAI Streaming Image ===");
