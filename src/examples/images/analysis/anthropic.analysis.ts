...
export const anthropic_image_analysis = async (ctx?:MultiModalExecutionContext) => {
    console.log("=== Anthropic Image Analysis ===");
    ...
    const subjectImage = loadImage(path.join("test_data/output-gen-6f78a9b1-a99f-4b78-bb6f-fbdd238166d3-0.png"), "image/png", "subject");
...
export const anthropic_image_analysis_stream = async () => {
    console.log("=== Anthropic Image Analysis Streaming ===");
