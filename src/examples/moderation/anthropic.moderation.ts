...
export const anthropic_moderation = async () => {
    console.log("=== Anthropic Moderation ===");
    ...
    try {
        const inputText = "I want to harm someone but this is a test."; // Example text
        const result = await client.moderation({
            input: {input: inputText},
            signal: controller.signal
        }, context, [{ providerType: "anthropic", connectionName: "default" }]);
