...
> extends ProviderCapability {
     ...
     */
    generateImage(req: AIRequest<TInput>, ctx: MultiModalExecutionContext): Promise<AIResponse<TOutput>>;
}
...
export interface ImageGenerationStreamCapability<TInput = any, TOutput = NormalizedImage[]> extends ProviderCapability {
     ...
     */
    generateImageStream(request: AIRequest<TInput>, ctx: MultiModalExecutionContext): AsyncGenerator<AIResponseChunk<TOutput>>;
}
...
export interface ImageAnalysisCapability<TInput = unknown, TOutput = NormalizedImageAnalysis[]> extends ProviderCapability {
     ...
     */
    analyzeImage(request: AIRequest<TInput>, ctx: MultiModalExecutionContext): Promise<AIResponse<TOutput>>;
}
...
> extends ProviderCapability {
     ...
     * @template TOutput Output type (partial chunks or final data)
     */
    analyzeImageStream(request: AIRequest<TInput>, ctx: MultiModalExecutionContext): AsyncGenerator<AIResponseChunk<TOutput>>;
}
...
export interface ImageEditCapability<TInput = unknown, TOutput = NormalizedImage[]> extends ProviderCapability {
     ...
     */
    editImage(request: AIRequest<TInput>, ctx: MultiModalExecutionContext): Promise<AIResponse<TOutput>>;
}
...
export interface ImageEditStreamCapability<TInput = unknown, TOutput = NormalizedImage[]> extends ProviderCapability {
     ...
     */
    editImageStream(request: AIRequest<TInput>, ctx: MultiModalExecutionContext): AsyncGenerator<AIResponseChunk<TOutput>>;
}
